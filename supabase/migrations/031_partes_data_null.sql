-- ============================================================================
-- 031_partes_data_null.sql — pode_editar_local v5: tolera arranjo sem data.
-- Arranjos legados (recorrentes antigos) têm data null — a parte deles
-- deve valer mesmo assim (home e guard já toleram; RLS acompanha).
-- ============================================================================
